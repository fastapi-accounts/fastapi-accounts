...
If you believe you have found a security vulnerability, please report it securely via the [GitHub Security Advisory form](https://github.com/fastapi-accounts/fastapi-accounts/security/advisories/new).
